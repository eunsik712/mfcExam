...
Cday4Dlg::Cday4Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DAY4_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(Cday4Dlg, CDialogEx)
	...
	ON_WM_QUERYDRAGICON()
	ON_WM_DESTROY()
	ON_BN_CLICKED(IDC_BTN_TEST, &Cday4Dlg::OnBnClickedBtnTest)
END_MESSAGE_MAP()
...
void Cday4Dlg::callFunc(int n) {
	// int nData = n;
	cout << n << endl;
}

void Cday4Dlg::OnBnClickedBtnTest()
{
